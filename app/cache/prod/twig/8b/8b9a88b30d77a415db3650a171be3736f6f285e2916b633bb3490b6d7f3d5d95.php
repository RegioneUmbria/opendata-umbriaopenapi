...
class __TwigTemplate_272306edf6d6ee95e98a8c6e23a36bdb88c25ff24565911e16a9602066bc7d7c extends Twig_Template
{
...
";
    ...
    <script>
        ...
        $context['_seq'] = twig_ensure_traversable(($context["attrattori"] ?? null));
        ...
        // line 44
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["proposte"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 45
            echo "            {
                id: ";
        ...
        // line 57
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["eventi"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 58
            echo "            {
                id: ";
        ...
        // line 70
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["agenzieViaggio"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 71
            echo "            {
                id: ";
        ...
        // line 83
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["consorzi"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 84
            echo "            {
                id: ";
        ...
        // line 96
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["professioni"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 97
            echo "            {
                id: ";
        ...
        // line 109
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["iat"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 110
            echo "            {
                id: ";
        ...
        // line 122
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["sportFacility"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 123
            echo "            {
                id: ";
        ...
        // line 135
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["accomodation"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 136
            echo "            {
                id: ";
...
";
    ...
    {
        return new Twig_Source("", "UmbriaProLocoBundle:Default:index.html.twig", "/var/www/html/opendata-umbriaopenapi-nigel/src/Umbria/ProLocoBundle/Resources/views/Default/index.html.twig");
    }
}
