...
<<<<<<< HEAD
     ...
     */
    protected function getLifeumriabot_MyUpdateReceiverService()
    {
        return $this->services['lifeumriabot.my_update_receiver'] = new \Umbria\TelegramBotBundle\UpdateReceiver\UpdateReceiver($this->get('shaygan.telegram_bot_api'), array('token' => '435563012:AAGuGRnKfchsEesuc2XfAR9X7OhQQPAYnyw'), $this->get('doctrine.orm.default_entity_manager'));
    }
