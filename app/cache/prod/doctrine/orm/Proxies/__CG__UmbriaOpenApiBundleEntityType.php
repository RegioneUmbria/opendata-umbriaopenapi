 ...
 */
class Type extends \Umbria\OpenApiBundle\Entity\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Type' . "\0" . 'uri', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Type' . "\0" . 'name', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Type' . "\0" . 'comment'];
        }
