 ...
 */
class Category extends \Umbria\OpenApiBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Category' . "\0" . 'uri', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Category' . "\0" . 'comment'];
        }
