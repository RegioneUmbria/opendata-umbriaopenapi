 ...
 */
class Iat extends \Umbria\OpenApiBundle\Entity\Tourism\GraphsEntities\Iat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'uri', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'name', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'email', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'telephone', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'fax', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'types', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'language', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'municipalitiesList', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'address', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'lat', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'lng', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Iat' . "\0" . 'lastUpdateAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Iat $proxy) {
    ...
    public function setMunicipalitiesList($municipalitiesList)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMunicipalitiesList', [$municipalitiesList]);

        return parent::setMunicipalitiesList($municipalitiesList);
    }
    ...
    public function getMunicipalitiesList()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMunicipalitiesList', []);

        return parent::getMunicipalitiesList();
    }
