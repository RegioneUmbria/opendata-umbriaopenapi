 ...
 */
class ExternalResource extends \Umbria\OpenApiBundle\Entity\ExternalResource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\ExternalResource' . "\0" . 'uri', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\ExternalResource' . "\0" . 'name', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\ExternalResource' . "\0" . 'types', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\ExternalResource' . "\0" . 'description', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\ExternalResource' . "\0" . 'resourceOriginUrl'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExternalResource $proxy) {
