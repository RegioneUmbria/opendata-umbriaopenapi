 ...
 */
class Event extends \Umbria\OpenApiBundle\Entity\Tourism\GraphsEntities\Event implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'uri', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'name', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'images', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'startDate', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'endDate', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'resourceOriginUrl', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'lat', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'lng', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'istat', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'municipality', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'types', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'language', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'descriptions', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'comment', '' . "\0" . 'Umbria\\OpenApiBundle\\Entity\\Tourism\\GraphsEntities\\Event' . "\0" . 'lastUpdateAt'];
        }
