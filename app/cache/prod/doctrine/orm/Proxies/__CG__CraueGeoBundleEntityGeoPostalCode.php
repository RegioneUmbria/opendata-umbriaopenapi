...
namespace Proxies\__CG__\Craue\GeoBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class GeoPostalCode extends \Craue\GeoBundle\Entity\GeoPostalCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'country', 'postalCode', 'lat', 'lng'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GeoPostalCode $proxy) {
