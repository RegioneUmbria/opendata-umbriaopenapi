...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'uoa', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EntityManager5965d43f33cb6_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager5965d43f33cb6_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_5965d43f33cb6.php');

        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5965d43f33cb6_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($this->get('doctrine.orm.default_entity_manager.delegate'), $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_98964b323f8512f6f11b383862930efb9e9d46bd12161384f45ca452ef6f354d');
    ...
    {
        return $this->services['shaygan.my_update_receiver'] = new \Shaygan\TelegramBotApiBundle\UpdateReceiver\UpdateReceiver($this->get('shaygan.telegram_bot_api'), array('token' => '435563012:AAH_yQzxrQbL5fCT5Xuyftr645_EDdJEBd4', 'webhook' => array('domain' => 'umbriaopenapi.regione.umbria.it', 'path_prefix' => '/opendata-umbriaopenapinigel/web', 'update_receiver' => 'umbria_telegram_bot.my_update_receiver')));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/shaygan/telegram-bot-api-bundle/Shaygan/TelegramBotApiBundle/Resources/views'), 'ShayganTelegramBotApi');
    ...
    {
        return $this->services['umbria_telegram_bot.my_update_receiver'] = new \Umbria\TelegramBotBundle\UpdateReceiver\UpdateReceiver($this->get('shaygan.telegram_bot_api'), array('token' => '435563012:AAH_yQzxrQbL5fCT5Xuyftr645_EDdJEBd4', 'webhook' => array('domain' => 'umbriaopenapi.regione.umbria.it', 'path_prefix' => '/opendata-umbriaopenapinigel/web', 'update_receiver' => 'umbria_telegram_bot.my_update_receiver')), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5965d43f129b04.69855259')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_5965d43f33cb6.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5965d43f33cb6_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'shaygan_telegram_bot_api.config' => array(
                ...
                'webhook' => array(
                    ...
                    'path_prefix' => '/opendata-umbriaopenapinigel/web',
